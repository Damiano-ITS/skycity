...
export default function NuovaSegnalazioneModal({ onClose, onSave }: FormProps) {
        ...
        <form onSubmit={handleSubmit}>
          <div className="m-modal__body m-modal__body--form">
            <div>
              ...
              <input type="text" placeholder="es. bk-999" value={veicoloId} onChange={e => setVeicoloId(e.target.value)} className="m-input-field" required />
            </div>
            <div>
              <label className="info-label">Tipo Veicolo</label>
              <select value={tipoVeicolo} onChange={e => setTipoVeicolo(e.target.value as any)} className="m-input-select">
            ...
            <div>
              ...
              <input type="text" placeholder="Descrivi brevemente il problema" value={problema} onChange={e => setProblema(e.target.value)} className="m-input-field" required />
            </div>
            <div>
            ...
            <div>
              ...
              <textarea placeholder="Inserisci note aggiuntive..." value={descrizione} onChange={e => setDescrizione(e.target.value)} className="m-input-textarea" />
            </div>
          </div>
